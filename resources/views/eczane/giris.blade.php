...
<div style="background:#fff;border-radius:16px;border:1px solid #e0e8f0;padding:40px;width:100%;max-width:440px">
    ...
    <div style="text-align:center;margin-bottom:32px">
        <h1 style="font-size:24px;font-weight:700;color:#1a2236;margin-bottom:8px">Eczane Girişi</h1>
        <p style="color:#718096;font-size:14px">pharmadepom.com eczane panelinize giriş yapın</p>
    </div>
    ...
    <form method="POST" action="/eczane/giris">
        @csrf
    ...
    <p style="text-align:center;margin-top:20px;font-size:14px;color:#718096">
        Hesabınız yok mu? <a href="/eczane/kayit" style="color:#0057b8;font-weight:600">Kayıt Olun</a>
    </p>

    <div style="border-top:1px solid #e0e8f0;margin-top:24px;padding-top:20px;text-align:center">
        <p style="font-size:13px;color:#718096;margin-bottom:12px">Depo hesabınız var mı?</p>
        <a href="/depo/giris" style="color:#0057b8;font-size:14px;font-weight:600">Depo Girişi →</a>
    </div>
